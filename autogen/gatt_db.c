...
{
  0x7e, 0xe4, 0xc5, 0x8c, 0x08, 0x3c, 0x44, 0x80, 0xb0, 0x46, 0x5a, 0x5d, 0xf5, 0x23, 0xa0, 0x49, 
  0x7e, 0xe4, 0xc5, 0x8c, 0x08, 0x3c, 0x44, 0x80, 0xb0, 0x46, 0x5a, 0x5d, 0xf8, 0x23, 0xa0, 0x49, 
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_10) = {
  .properties = 0x0a,
  .max_len = 11,
  .data = { 0x53, 0x50, 0x50, 0x20, 0x45, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, },
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x1d, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x04, .char_uuid = 0x8001 } },
  { .handle = 0x1e, .uuid = 0x8001, .permissions = 0x804, .caps = 0xffff, .state = 0x00, .datatype = 0x02, .dynamicdata = &gattdb_attribute_field_29 },
